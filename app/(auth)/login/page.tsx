						...
						<div className="space-y-2">
							...
							<div className="relative">
								<input
									...
									className="block w-full rounded-md border border-gray-300 px-3 py-2 pr-10 text-sm text-gray-900 outline-none ring-0 transition placeholder:text-gray-400 focus:border-gray-400"
									value={password}
